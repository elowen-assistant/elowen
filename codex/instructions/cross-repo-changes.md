...
- When a repository needs edge-run validation, define its build/test commands in `.assistant/config.toml` rather than hardcoding repo behavior in `elowen-edge`.
